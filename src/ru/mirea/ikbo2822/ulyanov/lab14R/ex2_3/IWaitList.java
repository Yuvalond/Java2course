...
//Расширить и модифицировать исходный код WaitList, как
//необходимо, чтобы полностью реализовать всю схему UML. Включить
//комментарии Javadoc. Обратите внимание на переключение ролей после
//реализации каждого интерфейса / класса!
