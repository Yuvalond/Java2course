package ru.mirea.ikbo2822.ulyanov.lab4R.human;
import ru.mirea.ikbo2822.ulyanov.lab4R.human.body.*;

//Создать класс, описывающий тело человека(Human). Для описания
//каждой части тела создать отдельные классы(Head, Leg, Hand). Описать
//необходимые свойства и методы для каждого класса. Протестировать работу
//класса Human.
