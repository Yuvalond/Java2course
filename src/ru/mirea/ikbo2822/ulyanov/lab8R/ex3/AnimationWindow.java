package ru.mirea.ikbo2822.ulyanov.lab8R.ex3;
...
public class AnimationWindow extends JFrame {
    ...
    public AnimationWindow() {
        ...
        timer = new Timer(frameDelay, new ActionListener() {@Override  public void actionPerformed(ActionEvent e) {updateFrame();}});
        timer.start();
    }
